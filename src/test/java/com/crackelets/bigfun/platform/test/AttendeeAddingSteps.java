...
public class AttendeeAddingSteps {
    ...
    @Then("An Attendee Resource is included in Response Body, with values {string}, {string}, {string}")
    public void an_attendee_resource_is_included_in_response_body_with_values(String name, String userName, String email) {
        // implementation for checking if the response body contains an attendee resource with the given values
    }

    @Given("An Attendee Resource with values {string}, {string}, {string} is already stored")
    public void an_attendee_resource_with_values_is_already_stored(String name, String userName, String email) {
        // implementation for storing an attendee resource with the given values
    }
